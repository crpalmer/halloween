...
#define SONG_WAV	"bowie.wav"
#define VOCALS_VSA	"bowie-vocals.csv"
#define DRUM_VSA	"bowie-drum.csv"
#define GUITAR_VSA	"bowie-guitar.csv"
#define KEYBOARD_VSA	"bowie-keyboard.csv"
...
init_servos(void)
{
    vocals = talking_skull_actor_new_vsa(VOCALS_VSA, servo_update, &vocals_state);
    drum = talking_skull_actor_new_vsa(DRUM_VSA, drum_update, &drum_state);
    guitar = talking_skull_actor_new_vsa(GUITAR_VSA, servo_update, &guitar_state);
    keyboard = talking_skull_actor_new_vsa(KEYBOARD_VSA, keyboard_update, &keyboard_state);
