...
static inline int ween2019_is_ignored()
{
    struct stat s;
...
static inline void ween2019_wait_until_valid()
{
    ...
    while (! (ween2019_is_ignored() || ween_time_is_valid(ween_time_constraints, n_ween_time_constraints))) {
	ms_sleep(1000);
    }
}
